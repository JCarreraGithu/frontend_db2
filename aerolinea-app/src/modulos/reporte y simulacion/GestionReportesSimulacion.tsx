...
const GestionReportesSimulacion = () => {
  ...
  const opciones = [
    ...
    { titulo: 'Simulación Tráfico Aéreo', descripcion: 'Ejecuta simulaciones del tráfico aéreo para prever cuellos de botella y saturación.', ruta: '/dashboard/reporte y simulacion/SimulacionTraficoAereo' },

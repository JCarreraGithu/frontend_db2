...
import ProgramacionEstacional from '../modulos/reporte y simulacion/ProgramacionMundial/ProgramacionEstacional';
  ...
  return (
    <Routes>
      ...
      >
        ...
        <Route path="vehiculo/ProgramacionEstacional" element={<ProgramacionEstacional/>} />
